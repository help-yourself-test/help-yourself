      ...
      <div className="tab-content">
                    ...
                    <div className="card-content">
                      {profileData.portfolio.linkedin && (
                        <div className="info-item">
                          <Linkedin size={16} />
                          <a
                            href={profileData.portfolio.linkedin}
                            target="_blank"
                      ...
                      {profileData.portfolio.github && (
                        <div className="info-item">
                          <Github size={16} />
                          <a
                            href={profileData.portfolio.github}
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                            GitHub Profile
                      ...
                      {profileData.portfolio.website && (
                        <div className="info-item">
                          <Globe size={16} />
                          <a
                            href={profileData.portfolio.website}
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                            Personal Website
        ...
        {activeTab === "skills" && (
          <div className="skills-tab">
            <div className="tab-header">
              <h3>
                <Trophy size={20} /> Skills & Expertise
              </h3>
              {isEditing && (
        ...
        {activeTab === "documents" && (
          <div className="documents-tab">
            <div className="tab-header">
              <h3>
                <FileText size={20} /> Documents & Portfolio
              </h3>
            </div>
          ...
          <div className="preferences-tab">
            ...
            {isEditing ? (
              <div className="preferences-form">
                <div className="form-section">
                  <h4>
                    <DollarSign size={18} /> Salary Expectations
                  </h4>
